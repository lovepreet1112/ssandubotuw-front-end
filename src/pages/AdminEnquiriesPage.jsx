          ...
          <div className="overflow-x-auto">
            <table className="w-full text-left text-xs">
              ...
              <tbody className="divide-y divide-[#DDCBA4]/30 text-[#2A2923]">
                {loading ? (
                  <TableLoader colSpan={6} message="Loading customer enquiries..." />
                ) : contacts.length === 0 ? (
                  <TableEmpty colSpan={6} message="No customer messages received yet" />
                ) : (
                  contacts.map((c) => (
        ...
        <div className="bg-white border border-[#DDCBA4]/60 rounded-sm shadow-sm overflow-hidden max-w-2xl">
          <div className="overflow-x-auto">
            <table className="w-full text-left text-xs">
              ...
              <tbody className="divide-y divide-[#DDCBA4]/30 text-[#2A2923]">
                {loading ? (
                  <TableLoader colSpan={3} message="Loading newsletter subscribers..." />
                ) : subscribers.length === 0 ? (
                  <TableEmpty colSpan={3} message="No newsletter subscribers recorded yet" />
                ) : (
                  subscribers.map((s) => (
